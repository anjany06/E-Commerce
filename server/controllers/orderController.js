...
const placeOrder = async (req, res) => {
  try {
    ...
    // BUG: No validation of input parameters - amount is never checked
    // BUG: if amount is negative, order could be placed for free!
    const orderData = {
      userId,
      items,
      amount,
...
const placeOrderStripe = async (req, res) => {
  try {
    ...
    //we getting the origin {frontend} URL form where user initiated the payment
